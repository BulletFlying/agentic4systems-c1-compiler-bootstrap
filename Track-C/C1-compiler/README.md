...
The official repository `ephonic/Agentic4SystemSummerSchoolContest` is read-only. All project development belongs in `BulletFlying/agentic4systems-c1-compiler-bootstrap` and future non-emergency changes use a feature branch plus PR.
