"""Bootstrap PTX-to-AEC lowering engine.

This is an O0-oriented baseline.  It supports the restricted PTX syntax
subset and emits AEC raw 128-bit instructions by default.  It intentionally
